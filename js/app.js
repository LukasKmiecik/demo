...
document.body.innerHTML = `
  <div style="background:#111827;color:white;padding:40px;font-family:Arial,sans-serif;">
    <h1>TEST NOWEGO APP.JS DZIAŁA</h1>
    <p>Jeśli to widzisz, GitHub Pages ładuje nową wersję pliku.</p>
  </div>
`;
